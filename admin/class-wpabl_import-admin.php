...
class Wpabl_import_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/wpabl_import-admin.css', array(), $this->version, 'all' );
